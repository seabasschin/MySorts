...
public class SelectionSort {
    ...
    public static ArrayList<Comparable> selectionSort( ArrayList<Comparable> input ) {
		ArrayList<Comparable> retArray = input;
        for (int i = 0; i < retArray.size(); i++) {
		    int min = min(retArray);
		    retArray.set(min, retArray.set(i, retArray.get(min) ) );
		}
		return retArray;
    }//end selectionSort -- O(?)
